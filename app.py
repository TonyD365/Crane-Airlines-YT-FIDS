...
def _default_flights() -> list[Flight]:
    ...
    return [
        Flight("CR015", "[YYZ] Toronto Pearson International Airport, Canada",     toronto_time_17_00,                          "5", FlightStatus.BC_BOARDING,     departure="[PEK] Beijing Capital International Airport, China"),
    ]
